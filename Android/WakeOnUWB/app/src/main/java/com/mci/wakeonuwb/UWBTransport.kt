...
//                    val wifi = this.context.getSystemService(Context.WIFI_SERVICE) as WifiManager?
//                    if (arduino_msg.contains("phone:")) {
//                        uwbtransportlistener?.onUwbDebugging("Received count: $messageCount, arduino_msg + \n")
//                        // TODO: Turn on WiFi here
//                        if (wifi != null && !wifi.isWifiEnabled) {
//                            wifi.setWifiEnabled(true)
//                            Thread.sleep(10) // sleep for 10 seconds to wait for wifi auto-connection
//                            uwbtransportlistener?.videoDisplay()
//
//
//                            // step 1: let the video play for 5 min
////                            Thread.sleep(10000)
//////                            Thread.sleep(300000)
////
////                            // step 2: Turn wifi off after 5 minutes. This imitates that we 'did' what we had to do with wifi,
////                            // and then the app is 'intelligently' turning wifi off.
////                            // Same as disconnect button, but added because I don't want to manually click it
////                            wifi.setWifiEnabled(false)
////                            usbStop()
////
////                            // step 3: then wait for another 5 min
////
////                            Thread.sleep(10000)
////                            Thread.sleep(300000)
//                        }
