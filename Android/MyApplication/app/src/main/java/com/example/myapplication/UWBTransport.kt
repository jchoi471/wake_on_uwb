...
class UWBTransport(private val context: Context, var arduino: Arduino) : ArduinoListener {
    ...
    //    public CountDownTimer cdt = new CountDownTimer(5000, 1000) {
    //
...
//                    // ref: https://stackoverflow.com/questions/58006340/enable-disable-wifi-on-android-29
                        val panelIntent = Intent(Settings.Panel.ACTION_WIFI)
                        startActivityForResult(context as Activity, panelIntent, 0, null)
...
//                    else if (bytes[0] == ZIGBEE_MSG_TYPE || bytes[0] == ZIGBEE_ACK_MSG_TYPE) //FIXME: MAC headers will be stripped eventually
//                    {
//                        //Good to go
//                    } else {
//                        //Any Other Messages
